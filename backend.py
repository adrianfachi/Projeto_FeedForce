...
if __name__ == "__main__":
    try:
        ...
        novo = create_user(
            ...
            user_total_score=150,
            user_role="admin",
            user_cellphone="11999999999"
        )
        print("Usuário criado:", novo)
        ...
        print(f"\n✏️ Atualizando usuário ID {user_id}...")
        print(update_user(user_id, user_total_score=200, user_name="João Atualizado"))

        print(f"\n🗑️ Deletando usuário ID {user_id}...")
        print(delete_user(user_id))

        print("\n🔐 Tentando login...")
        login = login_user("joao@email.com", "senha123")
        print(login)
